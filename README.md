...
🎓 Mechanical Engineering student building **strong, reliable foundations in Data Science & Machine Learning** through disciplined, project-driven learning.

⚙️ Currently in my **training arc** — mastering fundamentals, thinking in systems, and turning theory into clean, working solutions.

---

## 🚀 What I’m working on 🧠💻
- 🐍 Strengthening **Python fundamentals** (clean code, data structures, problem solving)
- 📊 **Data Analysis & EDA** using Pandas, NumPy & Matplotlib on real datasets
- 🤖 Core **Machine Learning algorithms** with proper evaluation & validation
- 🔁 Small but complete projects that go **end-to-end** (data → insight → result)
- 🧱 Building discipline through **daily systems**, not bursts of motivation

---

## 📌 Current Focus 🎯
- 📚 Revising Python, statistics & ML fundamentals
- 🛠️ Building 2–3 clean, well-documented data projects
...
- 🌱 Environments that value **long-term growth over short-term output**
- 🌍 Chances to contribute to meaningful, real-world problems

---

## 💡 Impact & mindset 🧠🔥
- ⚙️ **Systems over motivation**, **progress over perfection**
